...
public class Menetapkan_keputusan_1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menetapkan_keputusan1);
        ...
        btnjawaban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(getApplicationContext(), Rubrik_menetapkan_keputusan_1.class);
                startActivity(intent);
                finish();
            }
        });
