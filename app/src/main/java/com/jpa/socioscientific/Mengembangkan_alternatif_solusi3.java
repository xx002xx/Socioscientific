...
public class Mengembangkan_alternatif_solusi3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mengembangkan_alternatif_solusi3);
        ...
        String identifikasi = sh.getString("identifikasi123", "");
        String identifikasi2 = sh.getString("identifikasi223", "");
        String identifikasi3 = sh.getString("identifikasi323", "");
        ...
        btnjawaban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myEdit.putString("identifikasi123", isi_identifikasi.getText().toString());
                myEdit.putString("identifikasi223", isi_identifikasi2.getText().toString());
                myEdit.putString("identifikasi323", isi_identifikasi3.getText().toString());
                myEdit.apply();

                Intent intent=new Intent(getApplicationContext(), Rubrik_mengembangkan_alternatif3.class);
                startActivity(intent);
                finish();
            }
        });
