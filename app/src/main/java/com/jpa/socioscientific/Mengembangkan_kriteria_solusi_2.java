...
public class Mengembangkan_kriteria_solusi_2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mengembangkan_kriteria_solusi2);
        ...
        String identifikasi = sh.getString("kriteria12", "");
        String identifikasi2 = sh.getString("kriteria22", "");
        String identifikasi3 = sh.getString("kriteria32", "");
        ...
        btnjawaban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myEdit.putString("kriteria12", isi_identifikasi.getText().toString());
                myEdit.putString("kriteria22", isi_identifikasi2.getText().toString());
                myEdit.putString("kriteria32", isi_identifikasi3.getText().toString());
                myEdit.apply();

                Intent intent=new Intent(getApplicationContext(), Rubrik_mengembangkan_kriteria_2.class);
                startActivity(intent);
                finish();
            }
        });
