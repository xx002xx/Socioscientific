...
public class Mengevaluasi_keputusan_3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mengevaluasi_keputusan3);
        ...
        String identifikasi = sh.getString("isikepd13", "");
        ...
        btnjawaban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myEdit.putString("isikepd13", isi_identifikasi.getText().toString());
                myEdit.apply();

                Intent intent=new Intent(getApplicationContext(), Rubrik_mengevaluasi_keputusan_3.class);
                startActivity(intent);
                finish();
            }
        });
