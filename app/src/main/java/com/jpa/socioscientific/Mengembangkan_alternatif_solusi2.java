...
public class Mengembangkan_alternatif_solusi2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mengembangkan_alternatif_solusi2);
        ...
        String identifikasi = sh.getString("identifikasi12", "");
        String identifikasi2 = sh.getString("identifikasi22", "");
        String identifikasi3 = sh.getString("identifikasi32", "");
        ...
        btnjawaban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myEdit.putString("identifikasi12", isi_identifikasi.getText().toString());
                myEdit.putString("identifikasi22", isi_identifikasi2.getText().toString());
                myEdit.putString("identifikasi32", isi_identifikasi3.getText().toString());
                myEdit.apply();

                Intent intent=new Intent(getApplicationContext(), Rubrik_mengembangkan_alternatif2.class);
                startActivity(intent);
                finish();
            }
        });
