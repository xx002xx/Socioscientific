...
public class Mengevaluasi_alternatif_solusi_berdasarkan_kriteria_3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mengevaluasi_alternatif_solusi_berdasarkan_kriteria3);
        ...
        next_sli.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(), Mengevaluasi_alternatif_solusi_3.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        view.loadUrl("https://www.youtube.com/embed/pnuiEGuThsI");
