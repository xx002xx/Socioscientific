...
public class Mengidentifikasi_masalah_3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mengidentifikasi_masalah3);


        EditText isi_identifikasi = findViewById(R.id.isi_identifikasi3);
        SharedPreferences sharedPreferences = getSharedPreferences("MySharedPref", MODE_PRIVATE);
        SharedPreferences sh = getSharedPreferences("MySharedPref", Context.MODE_PRIVATE);
        String identifikasi = sh.getString("identifikasi23", "");
        ...
        btnjawaban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myEdit.putString("identifikasi23", isi_identifikasi.getText().toString());
                myEdit.apply();

                Intent intent=new Intent(getApplicationContext(), Rubrik_identifikasi_masalah3.class);
                startActivity(intent);
                finish();
            }
        });
