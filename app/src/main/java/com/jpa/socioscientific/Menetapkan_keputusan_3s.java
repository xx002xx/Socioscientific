...
public class Menetapkan_keputusan_3s extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menetapkan_keputusan3s);
        ...
        String identifikasi = sh.getString("kriteria1223ff", "");
        ...
        btnjawaban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myEdit.putString("kriteria1223ff", isi_identifikasi.getText().toString());
                myEdit.apply();

                Intent intent=new Intent(getApplicationContext(), Dilema_3ss.class);
                startActivity(intent);
                finish();
            }
        });
