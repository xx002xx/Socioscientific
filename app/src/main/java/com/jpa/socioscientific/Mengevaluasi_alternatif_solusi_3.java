...
public class Mengevaluasi_alternatif_solusi_3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mengevaluasi_alternatif_solusi3);
        ...
        String kelebihan1 = sh.getString("kelebihan123", "");
        String kekurangan1 = sh.getString("kekurangan123", "");

        String kelebihan2 = sh.getString("kelebihan223", "");
        String kekurangan2 = sh.getString("kekurangan223", "");

        String kelebihan3 = sh.getString("kelebihan323", "");
        String kekurangan3 = sh.getString("kekurangan323", "");
        ...
        btnjawaban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myEdit.putString("kelebihan123", isi_kelebihan1.getText().toString());
                myEdit.putString("kekurangan123", isi_kekurangan1.getText().toString());

                myEdit.putString("kelebihan223", isi_kelebihan2.getText().toString());
                myEdit.putString("kekurangan223", isi_kekurangan2.getText().toString());

                myEdit.putString("kelebihan323", isi_kelebihan3.getText().toString());
                myEdit.putString("kekurangan323", isi_kekurangan3.getText().toString());
                myEdit.apply();

                Intent intent=new Intent(getApplicationContext(), Rubrik_mengevaluasi_3.class);
                startActivity(intent);
                finish();
            }
        });
