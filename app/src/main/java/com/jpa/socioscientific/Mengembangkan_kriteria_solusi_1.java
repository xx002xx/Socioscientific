...
public class Mengembangkan_kriteria_solusi_1 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mengembangkan_kriteria_solusi1);
        ...
        String identifikasi = sh.getString("kriteria1", "");
        String identifikasi2 = sh.getString("kriteria2", "");
        String identifikasi3 = sh.getString("kriteria3", "");
        ...
        btnjawaban.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myEdit.putString("kriteria1", isi_identifikasi.getText().toString());
                myEdit.putString("kriteria2", isi_identifikasi2.getText().toString());
                myEdit.putString("kriteria3", isi_identifikasi3.getText().toString());
                myEdit.apply();

                Intent intent=new Intent(getApplicationContext(), Rubrik_mengembangkan_kriteria_1.class);
                startActivity(intent);
                finish();
            }
        });
