...
public class Mengevaluasi_alternatif_solusi_berdasarkan_kriteria_2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mengevaluasi_alternatif_solusi_berdasarkan_kriteria2);
        ...
        next_sli.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(), Mengevaluasi_alternatif_solusi_2.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        view.loadUrl("https://www.youtube.com/embed/bVRfZNG0h30");
